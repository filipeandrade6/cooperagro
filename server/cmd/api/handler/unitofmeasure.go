...
func MakeUnitOfMeasureHandlers(e *echo.Group, service unitofmeasure.UseCase) {
	e.POST("/unitsofmeasure", createUnitOfMeasure(service), middleware.AdminRequired)
	e.GET("/unitsofmeasure", readUnitOfMeasure(service))
	e.GET("/unitsofmeasure/:id", getUnitOfMeasure(service))
	e.PUT("/unitsofmeasure/:id", updateUnitOfMeasure(service), middleware.AdminRequired)
	e.DELETE("/unitsofmeasure/:id", deleteUnitOfMeasure(service), middleware.AdminRequired)
}
